...
В **Elixir** поддержка монад откровенно слабая. На практике удобно пользоваться **pipe**, **pipeline** и **with**. Остальное не очень хорошо вписывается в дизайн языка.

Монады -- совсем другой мир. Мир интересный, но, увы, не востребованный в коммерческом программировании.
