...
Курс также доступен в виде [сайта](https://elixircoursejunior.netlify.app/)(временный вариант, также материал на сайте может быть устаревшим!), скрипт для сборки доступен по [ссылки](https://pastebin.com/usGYNarR).
