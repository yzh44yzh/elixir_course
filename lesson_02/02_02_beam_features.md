...
Многое из этого так или иначе реализовано в виртуальных машин других языков: Java, .NET, JavaScript. Но совокупность этих свойств и особенности реализации делает BEAM уникальной и дает Эликсир и Эрланг разработчикам определенные преимущества.
...
Если процесс короткоживущий, то после его завершения вся память процесса целиком освобождается, а сборщик мусора даже не успевает поработать.
