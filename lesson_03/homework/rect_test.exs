...
defmodule RectTest do
  ...
  test "valid_rect" do
    ...
    assert valid_rect({:rect, {:point, 100, -10}, {:point, -10, 100}})
    assert valid_rect({:rect, {:point, 2, 1}, {:point, 1, 2}})
  ...
  test "intersect case 1" do
    ...
    #    |     |
    #     -----
    rect_1 = {:rect, {:point, 4, 1}, {:point, 3, 3}}
    rect_2 = {:rect, {:point, 2, 2}, {:point, 1, 4}}
  ...
  test "intersect case 2" do
    ...
    #   ---|---    |
    #       -------
    rect_1 = {:rect, {:point, 4, 1}, {:point, 2, 3}}
    rect_2 = {:rect, {:point, 3, 2}, {:point, 1, 4}}
  ...
  test "intersect case 3" do
    ...
    #     |    |
    #      ----
    rect_1 = {:rect, {:point, 3, 1}, {:point, 2, 4}}
    rect_2 = {:rect, {:point, 4, 2}, {:point, 1, 3}}
    assert intersect(rect_1, rect_2)
    assert intersect(rect_2, rect_1)
  end
  ...
  test "intersect case 4" do
    ...
    #   |           |
    #    -----------
    rect_1 = {:rect, {:point, 4, 1}, {:point, 1, 4}}
    rect_2 = {:rect, {:point, 3, 2}, {:point, 2, 3}}
    assert intersect(rect_1, rect_2)
    assert intersect(rect_2, rect_1)
  end

  test "intersect invalid rect" do
    rect_v = {:rect, {:point, 4, 1}, {:point, 3, 3}}
